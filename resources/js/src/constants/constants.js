...
export const TINYMCE_MEDIA_UPLOAD_URL                   = `${import.meta.env.VITE_API_URL}v1/upload`
...
export const CHANGE_PASSWORD_SUCCESS_MESSAGE            = "Password has been changed successfully!";
